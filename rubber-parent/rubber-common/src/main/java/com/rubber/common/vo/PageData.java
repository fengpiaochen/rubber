 ...
 */
package com.rubber.common.vo;

import java.util.ArrayList;
import java.util.List;

import com.rubber.common.model.BaseModel;
import com.rubber.common.vo.BaseExample.Criteria;
...
public class PageData<Entity extends BaseModel> {
	 ...
	 * 
	 * @param example
	 *            value to be assigned to property example
	 */
	...
	public String getOrderField() {
		if (orderField != null && !"".equals(orderField)) {
			StringBuffer sbf = new StringBuffer(orderField);
			char[] buffer = sbf.toString().toCharArray();
			...
			for(int idx : idxs){
				char ch = field.charAt(idx);
				field = orderField.substring(0,idx) + "_" + Character.toLowerCase(ch) + orderField.substring(idx + 1);
			}
			orderField = field;
		}
		return orderField;
	 ...
	 * 
	 * @param orderField
	 *            value to be assigned to property orderField
	 */
	 ...
	 * 
	 * @param icdCode
	 *            value to be assigned to property icdCode
	 */
	 ...
	 * 
	 * @param pageNum
	 *            value to be assigned to property pageNum
	 */
	 ...
	 * 
	 * @param numPerPage
	 *            value to be assigned to property numPerPage
	 */
	public void setNumPerPage(Integer numPerPage) {

		this.numPerPage = numPerPage == null || numPerPage < 1 ? Integer
				.valueOf(1) : numPerPage;
	}
